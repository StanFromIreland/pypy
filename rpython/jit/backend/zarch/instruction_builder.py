...
def build_e(mnemonic, _tup0):
    opcode1,opcode2 = _tup0
    @builder.arguments('')
    def encode_e(self):
...
def build_rr(mnemonic, _tup0, argtypes='r, r'):
    opcode, = _tup0
...
def build_rre(mnemonic, _tup0, argtypes='r, r'):
    opcode1,opcode2 = _tup0
    @builder.arguments(argtypes)
...
def build_rxy(mnemonic, _tup0, arguments='r/m, bidl'):
    opcode1,opcode2 = _tup0
...
def build_ri(mnemonic, _tup0):
    opcode,halfopcode = _tup0
...
def build_ril(mnemonic, _tup0, args='r/m, i32'):
    opcode,halfopcode = _tup0
    br = is_branch_relative(mnemonic)
...
def build_rs(mnemonic, _tup0, argtypes='r, r, bd'):
    opcode, = _tup0
    @builder.arguments(argtypes)
...
def build_rsy_a(mnemonic, _tup0):
    opcode1,opcode2 = _tup0
...
def build_rsy_b(mnemonic, _tup0):
    opcode1,opcode2 = _tup0
...
def build_rie_d(mnemonic, _tup0):
    opcode1,opcode2 = _tup0
    @builder.arguments('r,r,i16')
...
def build_rie_e(mnemonic, _tup0):
    opcode1,opcode2 = _tup0
    br = is_branch_relative(mnemonic)
    @builder.arguments('r,r,i16')
...
def build_rie_f(mnemonic, _tup0):
    opcode1,opcode2 = _tup0
...
def build_rie_a(mnemonic, _tup0):
    opcode1,opcode2 = _tup0
    br = is_branch_relative(mnemonic)
...
def build_rie_b(mnemonic, _tup0):
    opcode1,opcode2 = _tup0
    br = is_branch_relative(mnemonic)
...
def build_rie_c(mnemonic, _tup0, argtypes='r, i8, r/m, i16'):
    opcode1,opcode2 = _tup0
    br = is_branch_relative(mnemonic)
    @builder.arguments(argtypes)
...
def build_rrf_a(mnemonic, _tup0, argtypes='r, r, r'):
    opcode1,opcode2 = _tup0
    @builder.arguments(argtypes)
...
def build_rrf_c(mnemonic, _tup0, argtypes='r, r, r/m, -'):
    opcode1,opcode2 = _tup0
    @builder.arguments(argtypes)
...
def build_rrf_e(mnemonic, _tup0, argtypes):
    opcode1,opcode2 = _tup0
    @builder.arguments(argtypes)
...
def build_rxe(mnemonic, _tup0, argtypes):
    opcode1,opcode2 = _tup0
    @builder.arguments(argtypes)
...
def build_ris(mnemonic, _tup0, argtypes='r, i8, r/m, bd'):
    opcode1,opcode2 = _tup0
    @builder.arguments(argtypes)
...
def build_vrx(mnemonic, _tup0, argtypes='v, bid, m'):
    opcode1,opcode2 = _tup0
    @builder.arguments(argtypes)
...
def build_vrr_a(mnemonic, _tup0, argtypes='v, v, m, m, m'):
    opcode1,opcode2 = _tup0
    @builder.arguments(argtypes)
...
def build_vrr_b(mnemonic, _tup0, argtypes='v, v, v, m, m'):
    opcode1,opcode2 = _tup0
    @builder.arguments(argtypes)
...
def build_vrr_c(mnemonic, _tup0, argtypes='v, v, v, m, m, m'):
    opcode1,opcode2 = _tup0
    @builder.arguments(argtypes)
...
def build_vrr_e(mnemonic, _tup0, argtypes='v, v, v, v, m, m'):
    opcode1,opcode2 = _tup0
    @builder.arguments(argtypes)
...
def build_vri_a(mnemonic, _tup0, argtypes='v, i16, m'):
    opcode1,opcode2 = _tup0
    @builder.arguments(argtypes)
...
def build_vri_c(mnemonic, _tup0, argtypes='v, v, i16, m'):
    opcode1,opcode2 = _tup0
    @builder.arguments(argtypes)
...
def build_vrs_b(mnemonic, _tup0, argtypes='v, r, db, m'):
    opcode1,opcode2 = _tup0
    @builder.arguments(argtypes)
...
def build_vrs_c(mnemonic, _tup0, argtypes='r, v, db, m'):
    opcode1,opcode2 = _tup0
    @builder.arguments(argtypes)
