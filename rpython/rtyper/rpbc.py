...
class FunctionsPBCRepr(CanBeNull, FunctionReprBase):
    ...
    def convert_const(self, value):
        if isinstance(value, types.MethodType) and value.__self__ is None:
            value = value.__func__  # unbound method -> bare function
